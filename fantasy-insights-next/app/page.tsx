...
export default function Home() {
  ...
  const firstName = (data?.user?.name || data?.user?.email || "Coach").split(" ")[0];
        ...
        {status === "authenticated" ? (
          <>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center">
              ...
              >
                ...
                <div className="mt-2 text-2xl font-semibold">Open League Insights</div>
                <p className="mt-2 text-zinc-400">
                  Power rankings, steals & overpays, strength of schedule, and more.
                </p>
          ...
          <>
            ...
            <p className="mt-4 text-zinc-300">
              Sign in with Yahoo to load your league data and personalized insights.
            </p>
