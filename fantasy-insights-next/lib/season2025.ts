...
// ===== Types =====
export type PlayerFace = { name: string; image: string };
...
export type StealsOverpays = {
  steals: StealOverpayEntry[];
  overpays: StealOverpayEntry[];
};
...
export type StrengthOfSchedule = {
  ...
  grade: string;
  analysis: string;
  biggestGame?: { week: string; opponent: string; narrative: string } | null;
};

export type WeekData = {
  id: string; // "preseason", "week1"... "week17"
  shortLabel: string; // "Pre", "W1"... "W17"
  title: string;
  description: string;
  content: {
    powerRankings: LeaguePowerRanking[];
...
const preseasonPowerRankings: LeaguePowerRanking[] = [
  {
    rank: 1,
    team: "NBAngryWolfDan",
    analysis:
      "The top of the heap. This team is an absolute juggernaut. They paid up for De'Von Achane ($50) and Bucky Irving ($30), two of the most explosive running backs in the league. They also got a great value on Isiah Pacheco ($11), another great running back. But their true strength is their wide receiver corps. Jaxon Smith-Njigba ($45) and Cooper Kupp ($3) are both excellent values. They also got a top-tier quarterback in Justin Herbert for a shockingly low price of $3. This team is deep, talented, and has a great mix of youth and experience. They are the clear-cut favorite to win the league.",
  ...
  },
  {
    ...
    analysis:
      "This team is loaded with talent. They paid up for Alvin Kamara ($50) and Kenneth Walker III ($46), two solid running backs. But their real strength is at the wide receiver position. Garrett Wilson ($34), Travis Hunter ($17), and DeVonta Smith ($31) are all excellent values. They also got Jayden Daniels for $30, who could be a league-winner at quarterback. They even managed to get a great tight end in Travis Kelce for a shockingly low price of $18. This team is a well-oiled machine, and they are a legitimate championship contender.",
    ...
    players: [
      ...
      { name: "Travis Hunter", image: "https://a.espncdn.com/i/headshots/nfl/players/full/5092026.png" },
  ...
  },
  {
    ...
    team: "Wasted Money",
    analysis:
      'The Wasted Money manager seems to have a flair for the dramatic. They paid a ridiculous $92 for CeeDee Lamb, which is a bit of a head-scratcher when Justin Jefferson went for $2 less. Then they paid up for Derrick Henry ($82) and Drake London ($57). This team is all about the big names, consequences be damned. They have a solid core, but their bench is a graveyard of players they got for cheap. Mark Andrews for $15 is an absolute steal and a potential league-winner, but the rest of their supporting cast is not going to win them any games. They got their guys, but the "wasted money" might be the most accurate team name in the league.',
  ...
  },
  {
    ...
    likelihood:
      "Slim to none. They have a prayer, but a very, very small one.",
    players: [
...
// ===== Preseason: Steals & Overpays =====
const preseasonStealsOverpays: StealsOverpays = {
  steals: [
    {
      player: "Travis Kelce",
      cost: "$18",
    ...
    },
    {
      ...
      team: "#firebevell",
      reason:
        "I'm not saying this guy is good or anything, but he has won a couple of Super Bowls. He's also been the QB1 in fantasy a few times. To get him for just $23 is a joke. It's like finding a brand new Ferrari for the price of a used Honda. You can't pass this up. This is a league-winning kind of value.",
    ...
    },
    {
      ...
      team: "NBAngryWolfDan",
      reason:
        "The Chargers offense is a bit of a question mark this year, but a top-10 quarterback for $3 is an insane steal. That's a kicker price for a potential QB1. This is the kind of move that lets you pay up for your stud running backs and wide receivers. A fantastic value that lets you build a truly elite team.",
    ...
    },
    {
      ...
      team: "Wasted Money",
      reason:
        'It\'s in the team name, I guess, but this is a rare moment of brilliance from a "Wasted Money" manager. Mark Andrews is a consensus top-5 tight end, and he went for just $15. That\'s a TE1 for a price you\'d expect to pay for a mediocre bench player.',
    ...
    },
    {
      ...
      team: "The Bengal King",
      reason:
        "Breece Hall is a top-10 running back, and he went for just $43. That's a steal. He has the potential to be a league-winner, and he went for a price that's far below his market value.",
  ...
  overpays: [
    {
      ...
      team: "Pimp Named Slickback",
      reason:
        "Look, I get it. Ja'Marr Chase is a top-tier wide receiver. But $104? That's over a third of your starting budget on one player. He is not a $104 player, plain and simple. He's a great receiver, but that's a price that says \"I have no faith in my ability to find value elsewhere.\" This is the kind of overpay that sinks a team before the season even starts.",
    ...
    },
    {
      ...
      team: "BDB'z",
      reason:
        "A hundred and one dollars for a running back who has yet to prove he can be a top-5 fantasy producer. I'm not saying he's not good. He's great. But is he \"$101 great\"? In a world where Christian McCaffrey went for $91, this is a massive overpay. This screams \"I was desperate for a running back and panicked.\"",
...
const preseasonSoS: StrengthOfSchedule[] = [
  {
    team: "NBAngryWolfDan",
    grade: "A-",
    analysis:
      "This is a great schedule. You have a lot of manageable matchups, and you'll get to face off against some of the weaker teams in the league.",
    biggestGame: {
      week: "Week 2",
      opponent: "Scary Terry's Terror Squad",
      narrative:
        "The top two titans clash early! This Week 2 showdown against Scary Terry's Terror Squad will set the tone for who truly rules this league. Expect fireworks and maybe a little trash talk.",
    },
  },
  {
    team: "Scary Terry's Terror Squad",
    ...
    biggestGame: {
      ...
      narrative:
        "Forget Halloween, this Week 12 matchup against The Bengal King is the real fright night. A late-season battle with major playoff implications, where every catch and run could determine their destiny.",
    },
  },
  {
    team: "The Bengal King",
    ...
    biggestGame: {
      ...
      opponent: "Scary Terry's Terror Squad",
      narrative:
        "Kicking off the season with a bang! This Week 1 slugfest against Scary Terry's Terror Squad is a true test of their championship aspirations right out of the gate. No time for a warm-up, King.",
    },
  },
  {
    team: "#firebevell",
    ...
    biggestGame: {
      ...
      narrative:
        "Circle Week 10 on your calendars, folks! #firebevell faces the league's top dog, NBAngryWolfDan. This is their chance to prove they're more than just a playoff hopeful – they're a legitimate threat to the throne.",
    },
  },
  {
    team: "Stroud Control",
    grade: "B+",
    analysis:
      "This is a good schedule. You have a lot of manageable matchups, and you'll get to face off against some of the weaker teams in the league.",
    biggestGame: {
      week: "Week 13",
      opponent: "NBAngryWolfDan",
      narrative:
        "A late-season gauntlet! Stroud Control gets a shot at the top-ranked NBAngryWolfDan in Week 13. This game could either solidify their playoff spot or send them spiraling into the wild card abyss.",
    },
  },
  {
    team: "Pimp Named Slickback",
    ...
    biggestGame: {
      ...
      opponent: "NBAngryWolfDan",
      narrative:
        "Time to see if the pimp hand is strong! Facing the league leader, NBAngryWolfDan, in Week 6 is a prime opportunity for Pimp Named Slickback to make a statement. Or, you know, get humbled.",
    },
  },
  {
    team: "No Rookies",
    ...
    biggestGame: {
      ...
      opponent: "NBAngryWolfDan",
      narrative:
        "The 'No Rookies' philosophy gets its ultimate test in Week 4 against the top-ranked NBAngryWolfDan. Can veteran savvy overcome raw power? This is where we find out if experience truly trumps youth... or if it just means you're old.",
    },
  },
  {
    team: "Dr. Tran",
    grade: "B",
    analysis:
      "This isn't a walk in the park, but it's not a death sentence either. You have some tough matchups, but there are enough manageable games to give you a fighting chance.",
    biggestGame: {
      week: "Week 8",
      opponent: "NBAngryWolfDan",
      narrative:
        "A mid-season gut check! Dr. Tran faces the formidable NBAngryWolfDan in Week 8. This game will either be a stepping stone to respectability or a harsh dose of reality.",
    },
  },
  {
    team: "Edmonton End-Zone Elite",
    ...
    biggestGame: {
      ...
      opponent: "#firebevell",
      narrative:
        "The Canadian contingent gets a major challenge in Week 6 against #firebevell. This is their chance to prove they belong in the upper echelon, or just confirm they're happy being a middle-of-the-pack team.",
    },
  },
  {
    team: "Wasted Money",
    grade: "C+",
    analysis:
      "This is a tough schedule for a team that has some holes. You'll need your stars to stay healthy and play at an elite level to have any chance.",
    biggestGame: {
      week: "Week 5",
      opponent: "#firebevell",
      narrative:
        "The 'Wasted Money' squad gets a chance to redeem their draft spending in Week 5 against #firebevell. A win here would be huge for their playoff hopes, otherwise, it's just more money down the drain.",
    },
  },
  {
    team: "Saquon Two Three Four",
    ...
    biggestGame: {
      ...
      opponent: "#firebevell",
      narrative:
        "An early season test! Saquon Two Three Four faces #firebevell in Week 3. This game will show if their top-heavy roster can hang with the league's contenders, or if they'll be stuck in neutral.",
    },
  },
  {
    team: "BDB'z",
    ...
    biggestGame: {
      ...
      opponent: "#firebevell",
      narrative:
        "The BDB'z get a brutal mid-season draw against #firebevell in Week 8. With their top-heavy roster, this game is either a statement win or a stark reminder of their lack of depth.",
    },
  },
  {
    team: "The Jonathan Taylors",
    grade: "F",
    analysis:
      "This is a nightmare schedule. You're going to face a lot of strong teams, and you'll need a lot of luck to even make it to the playoffs.",
    biggestGame: {
      week: "Week 1",
      opponent: "NBAngryWolfDan",
      narrative:
        "Welcome to the thunderdome, Jonathan Taylors! Kicking off the season against the league's top team, NBAngryWolfDan, is a baptism by fire. This game could define their season's narrative before it even properly begins.",
    },
  },
  {
    team: "D&B",
    grade: "D",
    analysis:
      "The path to glory is a muddy, uphill battle. Your opponents are consistently stronger than you, and you'll need a lot of luck to even sniff the playoffs.",
    biggestGame: {
      week: "Week 1",
      opponent: "#firebevell",
      narrative:
        "Oh, D&B. Starting the season against #firebevell is like bringing a knife to a gunfight. This Week 1 matchup is less about winning and more about damage control. Good luck, you'll need it.",
    },
  },
];

// ===== Helper: scaffold weeks 1..17 with placeholders =====
function makeEmptyWeek(n: number): WeekData {
  return {
    id: `week${n}`,
    shortLabel: `W${n}`,
    title:
      n === 1
        ? "Week 1: Kickoff Chaos"
        : n === 2
        ? "Week 2: Early Season Showdowns"
        : n === 3
        ? "Week 3: The Contender's Crunch"
        : n === 4
        ? "Week 4: Mid-Season Mayhem"
        : `Week ${n}: League Headlines`,
    description:
      n === 1
        ? "The regular season begins! Early takes and matchups that shook the fantasy world."
        : n === 2
        ? "Recap of Week 2 battles and emerging trends. Who's hot and who's not?"
        : n === 3
        ? "Separating the contenders from the pretenders. Key injuries and waiver gems."
        : n === 4
        ? "Who’s making a playoff push, and who’s already packing it in?"
        : "Weekly notes, streaks, blowouts, upsets, and team of the week.",
    content: {
      powerRankings: [],
...
// ===== Export: weeks2025 =====
export const weeks2025: WeekData[] = [
  {
    id: "preseason",
    shortLabel: "Pre",
    title: "Preseason Blitz: Draft Wrap-Up",
    description:
      "A deep dive into the draft results and pre-season expectations, including power rankings, steals, overpays, and initial strength of schedule analysis.",
    content: {
      powerRankings: preseasonPowerRankings,
      stealsOverpays: preseasonStealsOverpays,
      strengthOfSchedule: preseasonSoS,
    },
  },
  ...Array.from({ length: 17 }, (_, i) => makeEmptyWeek(i + 1)),
];
