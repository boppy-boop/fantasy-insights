...
const weeksData = [
  {
    ...
    image: 'https://placehold.co/600x400/4a0e7f/ffffff?text=Preseason+Blitz',
    content: {
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/1e2a4a/ffffff?text=Week+1+Kickoff',
    content: {
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/6b2d3e/ffffff?text=Week+2+Showdowns',
    content: {
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/2f4f4f/ffffff?text=Week+3+Crunch',
    content: {
  ...
  },
  {
    ...
    image: 'https://placehold.co/600x400/8b4513/ffffff?text=Week+4+Mayhem',
    content: {
      ...
      case 'powerRankings':
        return (
          <div className="space-y-6">
            ...
            {content.powerRankings?.length > 0 ? (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-green-900 bg-opacity-30 p-6 rounded-xl shadow-lg border border-green-700">
              ...
              <div className="space-y-4">
                {content.stealsOverpays?.steals.length > 0 ? (
            ...
            <div className="bg-red-900 bg-opacity-30 p-6 rounded-xl shadow-lg border border-red-700">
              ...
              <div className="space-y-4">
                {content.stealsOverpays?.overpays.length > 0 ? (
      ...
      case 'strengthOfSchedule':
        return (
          <div className="space-y-6">
            ...
            {content.strengthOfSchedule?.length > 0 ? (
    ...
    <div className="min-h-screen bg-gray-900 font-sans text-gray-100 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto bg-gray-900 rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="flex overflow-x-auto px-4 pb-2">
            {weeksData.map((week) => (
              <div
                ...
                onClick={() => {
                  setActiveWeek(week);
                  setActiveInsightSection('powerRankings');
                }}
              >
                <img src={week.image} alt={week.title} className="w-full h-28 object-cover rounded-t-lg" />
                <div className="p-2 text-center">
                  <h4 className="text-lg font-semibold text-white">{week.title}</h4>
                  <p className="text-xs text-gray-300">{week.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="flex justify-center mt-6 space-x-4">
          <button
            className={`px-4 py-2 rounded-lg font-semibold transition-colors duration-200 ${activeInsightSection === 'powerRankings' ? 'bg-purple-700 text-white' : 'bg-gray-700 text-gray-300 hover:bg-purple-800'}`}
            onClick={() => setActiveInsightSection('powerRankings')}
          >
            Power Rankings
          </button>
          <button
            className={`px-4 py-2 rounded-lg font-semibold transition-colors duration-200 ${activeInsightSection === 'stealsOverpays' ? 'bg-green-700 text-white' : 'bg-gray-700 text-gray-300 hover:bg-green-800'}`}
            onClick={() => setActiveInsightSection('stealsOverpays')}
          >
            Steals & Overpays
          </button>
          <button
            className={`px-4 py-2 rounded-lg font-semibold transition-colors duration-200 ${activeInsightSection === 'strengthOfSchedule' ? 'bg-blue-700 text-white' : 'bg-gray-700 text-gray-300 hover:bg-blue-800'}`}
            onClick={() => setActiveInsightSection('strengthOfSchedule')}
          >
            Strength of Schedule
          </button>
        </div>
        <main className="mt-8 px-4 pb-12">{renderInsightContent()}</main>
      </div>
    </div>
  );
};
